...
import { expenseData, allCards } from "./data";
...
const HomeScreen = () => {
  ...
  // decrease the padding so it takes the full space
...
function ExpanseItem({ expense }: { expense: any }) {
  return (
    <View style={styles.listItem}>
      <View style={styles.listItemContent}>
        <Text style={styles.listItemTitle}>{expense.name}</Text>
        <Text style={styles.listItemSubtitle}>{expense.platform}</Text>
      </View>
